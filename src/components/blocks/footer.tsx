              ...
              <ul className="space-y-3">
                {FOOTER_LINKS.services.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-dark-400 hover:text-brand-blue transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <div className="flex gap-4 mt-5">
                <a
                  ...
                  className="text-dark-600 hover:text-brand-blue transition-colors duration-200"
                  aria-label="LinkedIn"
                >
