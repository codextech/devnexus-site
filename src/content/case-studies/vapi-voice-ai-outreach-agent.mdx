...
We built a multi-stage agentic system using [VAPI](https://vapi.ai) as the voice infrastructure layer, with a custom orchestration backend that handles the research, decision-making, and CRM integration.
